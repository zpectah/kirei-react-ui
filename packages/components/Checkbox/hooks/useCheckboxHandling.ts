...
import { UseCheckboxHandlingProps, UseCheckboxHandlingReturn } from 'types';

export const useCheckboxHandling = (props: UseCheckboxHandlingProps): UseCheckboxHandlingReturn => {
